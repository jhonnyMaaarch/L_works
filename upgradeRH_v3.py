...
### Project: RHEL upgrade. Mainly for OS version using python V2.    ###
###          For OS versions using python v3 Please use the twin -   ###
###          upgradeRH_v8.py - found in /u/sunny/Tools or xcatmn3:   ###
########################################################################
########################################################################
import os
import subprocess
...
#      print(I)
     ...
     power_stat = raw_input('would you like to reboot (y/n): ')
     if power_stat == 'y':
      os.system('reboot')
     else:
