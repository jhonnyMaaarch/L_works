...
#read -p "Enter OS to install (e.g RHEL-7.5-20180322.0-Server-ppc64-dvd1.iso): " OS#_Name
...
virt-install --name $virtName --memory $memSize --vcpus $numCPU --disk $deviceBL --location 'http://192.168.180.242:80/install/rhels7.5/ppc64' --os-variant $OS_ver --network bridge=br0 --extra-args "ip=$ipAddr::192.168.180.247:255.255.0.0:$virtName.gpfs.net:$netInterface:none"
