...
read -p "Enter network interface (e.g eth0): " netInterface
virt-install --name $virtName --memory $memSize --vcpus $numCPU --disk $deviceBL --location 'http://192.168.180.242:80/install/rhels7.7/ppc64' --os-variant $OS_ver --network bridge=br0 --extra-args "ip=$ipAddr::192.168.180.247:255.255.0.0:$virtName.gpfs.net:$netInterface:none"
