...
def main():
    ...
    or_int = raw_input('Enter the primary network interface you want to bridge (e.g eno2): ') 
    or_conf = 'ifcfg-'+or_int
    os.system('cat '+ or_conf)
    ipAddr = raw_input('Enter the IP address(e.g 10.20.28.1): ')
    ...
    os.system('ifconfig ' + br_int + ' ' + ipAddr + ' netmask 255.255.240.0 ' +'up')
    os.system('ifconfig ' + br_int + ' ' + 'up')
    os.system('ifconfig ' + or_int + ' ' + '0.0.0.0')
    os.system('virsh net-list --all')
#    os.system('virsh net-destroy default')
#    os.system('virsh net-undefine default') 
    ...
    CreateFile.write(host_name + '.pok.stglabs.ibm.com')
    CreateFile.write("\n")
    print(CreateFile.read())
    CreateFile.close()
